...
-- lưu ESP
local mobESP = {}
local MAX_DISTANCE = 5100 -- 👈 chỉ quét quái trong phạm vi 5000 stud
...
-- Thông báo chào mừng
Notification.new("<Color=Yellow>Dark Hub <Color=/>"):Display()
task.wait(1)
...
_G.imageLogo = "rbxassetid://122685424763006"
_G.Logo = "rbxassetid://122685424763006"
_G.NameHub = "https://discord.gg/vtgWe5V9bd" -- ชื่อ Hub
_G.Title = "Dark Hub " -- คำอธิบาย
-----------------------------------------------------------------
...
ImageButton.Image = "rbxassetid://122685424763006"
	...
	coroutine.resume(
		coroutine.create(
			function()
				...
				Circle.ZIndex = 10
				Circle.Image = "rbxassetid://122685424763006"
...
game:GetService("StarterGui"):SetCore(
    "SendNotification",
    {
        Title = "Dark Hub ",
        Text = "Đã Tải Xong",
        Icon = "rbxassetid://122685424763006",
        Duration = 5
    }
)
